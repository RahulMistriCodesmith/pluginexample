...
class SystemAlertWindowExample extends StatefulWidget {
  const SystemAlertWindowExample({Key? key}) : super(key: key);

  @override
  State<SystemAlertWindowExample> createState() => _SystemAlertWindowExampleState();
}

class _SystemAlertWindowExampleState extends State<SystemAlertWindowExample> {
      ...
      SystemWindowBody body = SystemWindowBody(
        rows: [
          EachRow(
            columns: [
              EachColumn(
                text: SystemWindowText(text: "Name: Virat", fontSize: 12, textColor: Colors.black45),
              ),
            ],
            gravity: ContentGravity.RIGHT,
          ),
          EachRow(columns: [
            EachColumn(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('System Alert Windows'),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
